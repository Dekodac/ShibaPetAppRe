export default function InventoryPage(){
    ...
    <div className="CreateAShibeGroup" style={{width: 585, height: 108, left: 463, top: 707, position: 'absolute'}}>
        ...
        <div className="CreateYourNextShibu" style={{width: 444, height: 56, left: 71, top: 36, position: 'absolute', textAlign: 'center', color: '#3D70BD', fontSize: 40, fontFamily: 'Tajawal', fontWeight: '900', wordWrap: 'break-word'}}>Create your next shibu</div>
    </div>
