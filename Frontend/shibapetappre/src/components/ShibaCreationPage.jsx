export default function ShibaCreationPage(){
  ...
  if (token === "undefined"){
    ...
    <div className="Group1" style={{width: 399, height: 88, left: 556, top: 711, position: 'absolute'}}>
        ...
        <div className="Create" style={{width: 337, height: 45, left: 31, top: 22, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 24, fontFamily: 'Kiwi Maru', fontWeight: '500', wordWrap: 'break-word'}}>CREATE</div>
    </div>
    <div className="ShibaAttributesGroup" style={{width: 743, height: 295, left: 410, top: 344, position: 'absolute'}}>
        ...
        <div className="CaneGroup" style={{width: 319, height: 39, left: 381, top: 230, position: 'absolute'}}>
            ...
            <div className="CaneTextField" style={{width: 282, height: 29, left: 27, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Cane equipped: yes/no</div>
        </div>
        <div className="DramaticMustacheGroup" style={{width: 319, height: 39, left: 381, top: 176, position: 'absolute'}}>
            ...
            <div className="DaramaticMustacheField" style={{width: 302, height: 29, left: 17, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Dramatic Mustache: yes/no</div>
        </div>
        <div className="HairBowGroup" style={{width: 319, height: 39, left: 381, top: 122, position: 'absolute'}}>
            ...
            <div className="HairclipField" style={{width: 261, height: 29, left: 17, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Hair-clip worn/notworn</div>
        </div>
        <div className="MuzzleGroup" style={{width: 319, height: 39, left: 381, top: 68, position: 'absolute'}}>
            ...
            <div className="MuzzleField" style={{width: 260, height: 29, left: 17, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Muzzle worn/notworn</div>
        </div>
        <div className="GlassesGroup" style={{width: 319, height: 39, left: 381, top: 14, position: 'absolute'}}>
            ...
            <div className="GlassesField" style={{width: 260, height: 29, left: 17, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Glasses worn/notworn</div>
        </div>
        <div className="BowtieGroup" style={{width: 319, height: 39, left: 21, top: 230, position: 'absolute'}}>
            ...
            <div className="BowtieField" style={{width: 252, height: 29, left: 43, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>BowTie worn/notworn</div>
        </div>
        <div className="TopHatGroup" style={{width: 319, height: 39, left: 21, top: 176, position: 'absolute'}}>
            ...
            <div className="TophatField" style={{width: 250, height: 29, left: 27, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Tophat worn/notworn</div>
        </div>
        <div className="FurColorGroup" style={{width: 319, height: 39, left: 21, top: 122, position: 'absolute'}}>
            ...
            <div className="FurColorField" style={{width: 234, height: 29, left: 43, top: 2, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Fur Color<br/></div>
        </div>
        <div className="EyeColorGroup" style={{width: 319, height: 39, left: 21, top: 68, position: 'absolute'}}>
            ...
            <div className="EyeColorField" style={{width: 234, height: 29, left: 43, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>EyeColor:</div>
        </div>
        <div className="NameGroup" style={{width: 319, height: 39, left: 21, top: 14, position: 'absolute'}}>
            ...
            <div className="Name" style={{width: 234, height: 29, left: 43, top: 5, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Name</div>
        </div>
    </div>
    <div className="UserInventoryHeaderGroup" style={{width: 326, height: 74, left: 1153, top: 27, position: 'absolute'}}>
        ...
        <div className="Logout" style={{width: 275.34, height: 37.84, left: 25.33, top: 18.50, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 24, fontFamily: 'Kiwi Maru', fontWeight: '500', wordWrap: 'break-word'}}>Logout<br/></div>
    </div>
</div>
    )
}
